...
{{ config(materialized='external', location=var('output_path') + '/acs_pums_individual_people_new_mexico_2023.parquet') }}
...
FROM read_csv('~/data/american_community_survey/2023/1-Year/csv_pnm/psam_p35.csv', 
              parallel=False,
              all_varchar=True,
              auto_detect=True)
