...
{{ config(materialized='external', location=var('output_path') + '/acs_pums_individual_people_michigan_2023.parquet') }}
...
FROM read_csv('~/data/american_community_survey/2023/1-Year/csv_pmi/psam_p26.csv', 
              parallel=False,
              all_varchar=True,
              auto_detect=True)
