...
{{ config(materialized='external', location=var('output_path') + '/acs_pums_individual_people_washington_2023.parquet') }}
...
FROM read_csv('~/data/american_community_survey/2023/1-Year/csv_pwa/psam_p53.csv', 
              parallel=False,
              all_varchar=True,
              auto_detect=True)
