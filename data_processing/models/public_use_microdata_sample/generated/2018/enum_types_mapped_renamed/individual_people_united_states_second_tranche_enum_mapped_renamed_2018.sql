...
{{ config(materialized='external', location=var('output_path') + '/acs_pums_individual_people_united_states_second_tranche_2018.parquet') }}
...
CASE CITWP
		...
		WHEN '2017' THEN '2017'
		WHEN '2018' THEN '2018'
	END::ENUM ('Not eligible - not naturalized','1939 or earlier - Bottom-coded','1940 - 1944','1945 - 1947','1948 - 1949','1950','1951','1952','1953','1954','1955','1956','1957','1958','1959','1960','1961','1962','1963','1964','1965','1966','1967','1968','1969','1970','1971','1972','1973','1974','1975','1976','1977','1978','1979','1980','1981','1982','1983','1984','1985','1986','1987','1988','1989','1990','1991','1992','1993','1994','1995','1996','1997','1998','1999','2000','2001','2002','2003','2004','2005','2006','2007','2008','2009','2010','2011','2012','2013','2014','2015','2016','2017','2018') AS "Year of naturalization write-in",
CASE COW
...
CASE MARHD
		...
		WHEN '1' THEN 'Yes'
		WHEN '2' THEN 'No'
		WHEN '8' THEN 'Suppressed for data year 2018 for select PUMAs'
	END::ENUM ('Not applicable - age less than 15 years; never married','Yes','No','Suppressed for data year 2018 for select PUMAs') AS "Divorced in the past 12 months",
CASE MARHM
		WHEN 'b' THEN 'Not applicable - age less than 15 years; never married'
		WHEN '1' THEN 'Yes'
		WHEN '2' THEN 'No'
...
CASE MARHYP
		...
		WHEN '2017' THEN '2017'
		WHEN '2018' THEN '2018'
	END::ENUM ('Not applicable - age less than 15 years; never married','1937 or earlier - Bottom-coded','1938','1939','1940','1941','1942','1943','1944','1945','1946','1947','1948','1949','1950','1951','1952','1953','1954','1955','1956','1957','1958','1959','1960','1961','1962','1963','1964','1965','1966','1967','1968','1969','1970','1971','1972','1973','1974','1975','1976','1977','1978','1979','1980','1981','1982','1983','1984','1985','1986','1987','1988','1989','1990','1991','1992','1993','1994','1995','1996','1997','1998','1999','2000','2001','2002','2003','2004','2005','2006','2007','2008','2009','2010','2011','2012','2013','2014','2015','2016','2017','2018') AS "Year last married",
CASE MIG
...
CASE YOEP
		...
		WHEN '1929' THEN '1929 or earlier - Bottom-coded'
		WHEN '1930' THEN '1930 - 1934'
		WHEN '1935' THEN '1935 - 1938'
		WHEN '1939' THEN '1939 - 1940'
		...
		WHEN '2017' THEN '2017'
		WHEN '2018' THEN '2018'
	END::ENUM ('Not eligible - Born in the US','1929 or earlier - Bottom-coded','1930 - 1934','1935 - 1938','1939 - 1940','1941 - 1942','1943 - 1944','1945','1946','1947','1948','1949','1950','1951','1952','1953','1954','1955','1956','1957','1958','1959','1960','1961','1962','1963','1964','1965','1966','1967','1968','1969','1970','1971','1972','1973','1974','1975','1976','1977','1978','1979','1980','1981','1982','1983','1984','1985','1986','1987','1988','1989','1990','1991','1992','1993','1994','1995','1996','1997','1998','1999','2000','2001','2002','2003','2004','2005','2006','2007','2008','2009','2010','2011','2012','2013','2014','2015','2016','2017','2018') AS "Year of entry",
CASE ANC
		WHEN '1' THEN 'Single'
		...
		WHEN '8' THEN 'Suppressed for data year 2018 for select PUMAs'
	END::ENUM ('Single','Multiple','Unclassified','Not reported','Suppressed for data year 2018 for select PUMAs') AS "Ancestry recode",
CASE ANC1P
		WHEN '000' THEN 'Suppressed for data year 2018 for select PUMAs'
...
CASE INDP
		...
		WHEN '1790' THEN 'MFG-Leather And Hide Tanning And Finishing, And Other Leather And Allied Products'
		...
		WHEN '6992' THEN 'FIN-Agencies, Brokerage, And Other Insurance Related Activates'
		WHEN '7071' THEN 'FIN-Lessors Of Real Estate, And Offices Of Real Estate Agents And Brokers'
		WHEN '7072' THEN 'FIN-Real Estate Property Managers, Offices Of Real Estates Appraisers, And Other Activities Related To Real Estates'
...
CASE NAICSP
		...
		WHEN '44511' THEN 'RET-Supermarkets And Grocery - Except Convenience Stores'
		...
		WHEN '7115' THEN 'Independent Artists, Writers, And Performers'
		...
		WHEN '721M' THEN 'Recreational Vehicle Parks And Camps, And Rooming And Boarding House, Dormitories, And Workers Camps'
...
CASE OCCP
		...
		WHEN '1555' THEN 'Other Engineering Technologists And Technicians, Except Drafters'
		...
		WHEN '2636' THEN 'ENT-Merchandise Displayers And Windows Trimmers'
		...
		WHEN '3725' THEN 'PRT-First-Line Supervisors of Security And Protective Service Workers, All Other'
		...
		WHEN '5740' THEN 'OFF-Secretaries And Administrative Assistants, Except Legal, Medial, And Executive'
		...
		WHEN '8000' THEN 'Grinding, Lapping, Polishing, And Buffing Machine Tool'
...
CASE SOCP
		...
		WHEN '151254' THEN 'CMM_Web Developers'
		...
		WHEN '19204X' THEN 'Geoscientists And Hydrologists, Except Geographers'
		...
		WHEN '1930XX' THEN 'Other Social Scientists'
		...
		WHEN '271026' THEN 'ENT-Merchandise Displayers And Windows Trimmers'
		...
		WHEN '273099' THEN 'ENT-Media And Communications Workers, All Other'
		...
		WHEN '436014' THEN 'OFF-Secretaries And Administrative, Except Legal, Medical, And Executive'
		...
		WHEN '475020' THEN 'EXT_Surface Mining Machine Operators And Earth Drillers'
		...
		WHEN '514033' THEN 'Grinding, Lapping, Polishing, And Buffing Machine Tool Setters, Operators, And Tenders, Metal and Plastic'
		WHEN '51403X' THEN 'Other Machine Tool Setters, Operators, And Tenders, Metal And Plastic'
		...
		WHEN '519080' THEN 'Dental And Ophthalmic Laboratory Technicians And Medical Appliance Technicians'
		...
		WHEN '999920' THEN 'Unemployed And Last Worked 5 Years Ago Or Earlier Or Never Worked'
	END::ENUM ('Not applicable - less than 16 years old or NILF who last worked more than 5 years ago or never worked','MGR-Chief Executives And Legislators','MGR-General And Operations Managers','MGR-Advertising And Promotions Managers','MGR-Marketing Managers','MGR-Sales Managers','MGR-Public Relations And Fundraising Managers','MGR-Administrative Services Managers','MGR-Facilities Managers','MGR-Computer And Information Systems Managers','MGR-Financial Managers','MGR-Compensation And Benefits Managers','MGR-Human Resources Managers','MGR-Training And Development Managers','MGR-Industrial Production Managers','MGR-Purchasing Managers','MGR-Transportation, Storage, And Distribution Managers','MGR-Farmers, Ranchers, And Other Agricultural Managers','MGR-Construction Managers','MGR-Education And Childcare Administrators','MGR-Architectural And Engineering Managers','MGR-Food Service Managers','MGR-Entertainment And Recreation Managers','MGR-Lodging Managers','MGR-Medical And Health Services Managers','MGR-Natural Sciences Managers','MGR-Property, Real Estate, And Community Association Managers','MGR-Social And Community Service Managers','MGR-Emergency Management Directors','MGR-Other Managers','BUS-Agents And Business Managers Of Artists, Performers, And Athletes','BUS-Buyers And Purchasing Agents, Farm Products','BUS-Wholesale And Retail Buyers, Except Farm Products','BUS-Purchasing Agents, Except Wholesale, Retail, And Farm Products','BUS-Claims Adjusters, Appraisers, Examiners, And Investigators','BUS-Compliance Officers','BUS-Cost Estimators','BUS-Human Resources Workers','BUS-Logisticians','BUS-Project Management Specialists','BUS-Management Analysts','BUS-Meeting Convention, And Event Planners','BUS-Fundraisers','BUS-Compensation, Benefits, And Job Analysis Specialists','BUS-Training And Development Specialists','BUS-Market Research Analysts And Marketing Specialists','BUS-Business Operations Specialists, All Other','FIN-Accountants And Auditors','FIN-Property Appraisers And Assessors','FIN-Budget Analysts','FIN-Credit Analysts','FIN-Financial Analysts','FIN-Personal Financial Advisors','FIN-Insurance Underwriters','FIN-Financial Examiners','FIN-Credit Counselors And Loan Officers','FIN-Tax Examiners And Collectors, And Revenue Agents','FIN-Tax Preparers','FIN-Other Financial Specialists','CMM-Computer And Information Research Scientists','CMM-Computer Systems Analysts','CMM-Information Security Analysts','CMM-Computer Programmers','CMM-Software Developers','CMM-Software Quality Assurance Analysts And Testers','CMM_Web Developers','CMM Web And Digital Interface Designers','CMM-Computer Support Specialists','CMM-Database Administrators And Architects','CMM-Network And Computer Systems Administrators','CMM-Computer Network Architects','CMM Computer Occupations, All Other','CMM-Actuaries','CMM-Operations Research Analysts','CMM-Other Mathematical Science Occupations','ENG-Architects, Except Landscape And Naval','ENG-Landscape Architects','ENG-Surveyors, Cartographers, And Photogrammetrists','ENG-Aerospace Engineers','ENG-Biomedical And Agricultural Engineers','ENG-Chemical Engineers','ENG-Civil Engineers','ENG-Computer Hardware Engineers','ENG-Electrical And Electronics Engineers','ENG-Environmental Engineers','ENG-Industrial Engineers, Including Health And Safety','ENG-Marine Engineers And Naval Architects','ENG-Materials Engineers','ENG-Mechanical Engineers','ENG-Petroleum, Mining And Geological Engineers, Including Mining Safety Engineers','ENG-Other Engineers','ENG-Architectural And Civil Drafters','ENG-Other Drafters','ENG-Electrical and Electronic Engineering Technologists And Technicians','ENG-Other Engineering Technologists And Technicians, Except Drafters','ENG-Surveying And Mapping Technicians','SCI-Agricultural And Food Scientists','SCI-Biological Scientists','SCI-Conservation Scientists And Foresters','SCI-Medical Scientists, And Life Scientists, All Other','SCI-Astronomers And Physicists','SCI-Atmospheric And Space Scientists','SCI-Chemists And Materials Scientists','SCI-Environmental Scientists And Specialists, Including Health','Geoscientists And Hydrologists, Except Geographers','SCI-Physical Scientists, All Other','SCI-Economists','SCI-Clinical And Counseling Psychologists','SCI-School Psychologists','SCI-Other Psychologists','SCI-Urban And Regional Planners','Other Social Scientists','SCI Agricultural And Food Science Technicians','SCI-Biological Technicians','SCI-Chemical Technicians','SCI-Environmental Science And Geoscience Technicians, And Nuclear Technicians','SCI-Other Life, Physical, And Social Science Technicians','SCI-Occupational Health And Safety Specialists And Technicians','CMS-Substance Abuse And Behavioral Disorder Counselors','CMS-Educational, Guidance, And Career Counselors And Advisors','CMS-Marriage And Family Therapists','CMS-Mental Health Counselors','CMS-Rehabilitation Counselors','CMS-Counselors, All Other','CMS-Child, Family, And School Social Workers','CMS-Healthcare Social Workers','CMS-Mental Health And Substance Abuse Social Workers','CMS-Social Workers All Other','CMS-Probation Officers And Correctional Treatment Specialists','CMS-Social And Human Service Assistants','CMS-Other Community And Social Service Specialists','CMS-Clergy','CMS-Directors, Religious Activities And Education','CMS-Religious Workers, All Other','LGL-Lawyers, And Judges, Magistrates, And Other Judicial Workers','LGL-Judicial Law Clerks','LGL-Paralegals And Legal Assistants','LGL-Title Examiners, Abstractors, And Searchers','LGL-Legal Support Workers, All Other','EDU-Postsecondary Teachers','EDU-Preschool And Kindergarten Teachers','EDU-Elementary And Middle School Teachers','EDU-Secondary School Teachers','EDU-Special Education Teachers','EDU-Tutors','EDU-Other Teachers And Instructors','EDU-Archivists, Curators, And Museum Technicians','EDU-Librarians And Media Collections Specialists','EDU-Library Technicians','EDU-Teaching Assistants','EDU-Other Educational Instruction and Library Workers','ENT-Artists And Related Workers','ENT-Commercial And Industrial Designers','ENT-Fashion Designers','ENT-Floral Designers','ENT-Graphic Designers','ENT-Interior Designers','ENT-Merchandise Displayers And Windows Trimmers','ENT-Other Designers','ENT-Actors','ENT-Producers And Directors','ENT-Athletes And Sports Competitors','ENT-Coaches And Scouts','ENT-Umpires, Referees, And Other Sports Officials','ENT-Dancers And Choreographers','ENT-Music Directors And Composers','ENT-Musicians And Singers','ENT-Disc Jockeys, Except Radio','ENT-Entertainers And Performers, Sports And Related Workers, All Other','ENT-Broadcast Announcers And Radio Disc Jockeys','ENT-News Analysts, Reporters, And Journalists','ENT-Public Relations Specialists','ENT-Editors','ENT-Technical Writers','ENT-Writers And Authors','ENT-Interpreters And Translators','ENT-Court Reporters And Simultaneous Captioners','ENT-Media And Communications Workers, All Other','ENT-Other Media And Communication Equipment Workers','ENT-Photographers','ENT-Television, Video, And Motion Picture Camera Operators And Editors','MED-Chiropractors','MED-Dentists','MED-Dietitians And Nutritionists','MED-Optometrists','MED-Pharmacists','MED-Physicians','MED-Surgeons','MED-Physician Assistants','MED-Podiatrists','MED-Occupational Therapists','MED-Physical Therapists','MED-Radiation Therapists','MED-Recreational Therapists','MED-Respiratory Therapists','MED-Speech-Language Pathologists','MED-Other Therapists','MED-Veterinarians','MED-Registered Nurses','MED-Nurse Anesthetists','MED-Audiologists','MED-Nurse Practitioners And Nurse Midwives','MED-Acupuncturists','MED-Healthcare Diagnosing Or Treating Practitioners, All Other','MED-Clinical Laboratory Technologists And Technicians','MED-Dental Hygienists','MED-Cardiovascular Technologists And Technicians','MED-Diagnostic Medical Sonographers','MED-Radiologic Technologists And Technicians','MED-Magnetic Resonance Imaging Technologists','MED-Nuclear Medicine Technologists And Medical Dosimetrists','MED-Emergency Medical Technicians','MED-Paramedics','MED-Pharmacy Technicians','MED-Psychiatric Technicians','MED-Surgical Technologists','MED-Veterinary Technologists And Technicians','MED-Dietetic Technicians And Ophthalmic Medical Technicians','MED-Licensed Practical And Licensed Vocational Nurses','MED-Medical Records Specialists','MED-Opticians, Dispensing','MED-Miscellaneous Health Technologists And Technicians','MED-Other Healthcare Practitioners And Technical Occupations','HLS-Home Health Aides','HLS-Personal Care Aides','HLS-Nursing Assistants','HLS-Orderlies And Psychiatric Aides','HLS-Occupational Therapy Assistants And Aides','HLS-Physical Therapist Assistants And Aides','HLS-Massage Therapists','HLS-Dental Assistants','HLS-Medical Assistants','HLS-Medical Transcriptionists','HLS-Pharmacy Aides','HLS-Veterinary Assistants And Laboratory Animal Caretakers','HLS-Phlebotomists','HLS-Other Healthcare Support Workers','PRT-First-Line Supervisors Of Correctional Officers','PRT-First-Line Supervisors Of Police And Detectives','PRT-First-Line Supervisors Of Fire Fighting And Prevention Workers','PRT-Miscellaneous First-Line Supervisors, Protective Service Workers','PRT-Firefighters','PRT-Fire Inspectors','PRT-Bailiffs','PRT-Correctional Officers And Jailers','PRT-Detectives And Criminal Investigators','PRT-Fish And Game Wardens And Parking Enforcement Officers','PRT-Police Officers','PRT-Animal Control Workers','PRT-Private Detectives And Investigators','PRT-Security Guards And Gaming Surveillance Officers','PRT-Crossing Guards And Flaggers','PRT-Transportation Security Screeners','PRT-School Bus Monitors','PRT-Other Protective Service Workers','EAT-Chefs And Head Cooks','EAT-First-Line Supervisors Of Food Preparation And Serving Workers','EAT-Cooks','EAT-Food Preparation Workers','EAT-Bartenders','EAT-Fast Food And Counter Workers','EAT-Waiters And Waitresses','EAT-Food Servers, Nonrestaurant','EAT-Dining Room And Cafeteria Attendants And Bartender Helpers.','EAT-Dishwashers','EAT-Hosts And Hostesses, Restaurant, Lounge, And Coffee Shop','EAT-Food Preparation And Serving Related Workers, All Other.','CLN-First-Line Supervisors Of Housekeeping And Janitorial Workers','CLN-First-Line Supervisors Of Landscaping, Lawn Service, And Groundskeeping Workers','CLN-Janitors And Building Cleaners','CLN-Maids And Housekeeping Cleaners','CLN-Pest Control Workers','CLN-Landscaping And Groundskeeping Workers','CLN-Tree Trimmers And Pruners','CLN-Other Grounds Maintenance Workers','PRS-Supervisors of Personal Care And Service Workers','PRS-Animal Trainers','PRS-Animal Caretakers','PRS-Gambling Services Workers','PRS-Ushers, Lobby Attendants, And Ticket Takers','PRS-Other Entertainment Attendants And Related Workers','PRS-Morticians, Undertakers, And Funeral Arrangers','PRS-Embalmers, Crematory Operators, And Funeral Attendants','PRS-Barbers','PRS-Hairdressers, Hairstylists, And Cosmetologists','PRS-Manicurists and Pedicurists','PRS-Skincare Specialists','PRS-Other Personal Appearance Workers','PRS-Baggage Porters, Bellhops, And Concierges','PRS-Tour And Travel Guides','PRS-Childcare Workers','PRS-Exercise Trainers And Group Fitness Instructors','PRS-Recreation Workers','PRS-Residential Advisors','PRS-Personal Care And Service Workers, All Other','SAL-First-Line Supervisors Of Retail Sales Workers','SAL-First-Line Supervisors Of Non-Retail Sales Workers','SAL-Cashiers','SAL-Counter And Rental Clerks','SAL-Parts Salespersons','SAL-Retail Salespersons','SAL-Advertising Sales Agents','SAL-Insurance Sales Agents','SAL-Securities, Commodities, And Financial Services Sales Agents','SAL-Travel Agents','SAL-Sales Representatives Of Services, Except Advertising, Insurance, Financial Services, And Travel','SAL-Sales Representatives, Wholesale And Manufacturing','SAL-Models, Demonstrators, And Product Promoters','SAL-Real Estate Brokers And Sales Agents','SAL-Sales Engineers','SAL-Telemarketers','SAL-Door-To-Door Sales Workers, News And Street Vendors, And Related Workers','SAL-Sales And Related Workers, All Other','Off-First-Line Supervisors Of Office And Administrative Support Workers','OFF-Switchboard Operators, Including Answering Service','OFF-Telephone Operators','OFF-Communications Equipment Operators, All Other','OFF-Bill And Account Collectors','OFF-Billing And Posting Clerks','OFF-Bookkeeping, Accounting, And Auditing Clerks','OFF-Payroll And Timekeeping Clerks','OFF-Procurement Clerks','OFF-Tellers','OFF-Other Financial Clerks','OFF-Court, Municipal, And License Clerks','OFF-Credit Authorizers, Checkers, And Clerks','OFF-Customer Service Representatives','OFF-Eligibility Interviewers, Government Programs','OFF-File Clerks','OFF-Hotel, Motel, And Resort Desk Clerks','OFF-Interviewers, Except Eligibility And Loan','OFF-Library Assistants, Clerical','OFF-Loan Interviewers And Clerks','OFF-New Accounts Clerks','OFF-Correspondence Clerks And Order Clerks','OFF-Human Resources Assistants, Except Payroll And Timekeeping','OFF-Receptionists And Information Clerks','OFF-Reservation And Transportation Ticket Agents And Travel Clerks','OFF-Other Information And Records Clerks','OFF-Cargo And Freight Agents','OFF-Couriers And Messengers','OFF-Public Safety Telecommunicators','OFF-Dispatchers, Except Police, Fire, And Ambulance','OFF-Meter Readers, Utilities','OFF-Postal Service Clerks','OFF-Postal Service Mail Carriers','OFF-Postal Service Mail Sorters, Processors, And Processing Machine Operators','OFF-Production, Planning, And Expediting Clerks','OFF-Shipping, Receiving, And Traffic Clerks','OFF-Weighers, Measurers, Checkers, And Samplers, Recordkeeping','OFF-Executive Secretaries And Executive Administrative Assistants','OFF-Legal Secretaries And Administrative Assistants','OFF-Medical Secretaries And Administrative Assistants','OFF-Secretaries And Administrative, Except Legal, Medical, And Executive','OFF-Data Entry Keyers','OFF-Word Processors And Typists','OFF-Insurance Claims And Policy Processing Clerks','OFF-Mail Clerks And Mail Machine Operators, Except Postal Service','OFF-Office Clerks, General','OFF-Office Machine Operators, Except Computer','OFF-Proofreaders And Copy Markers','OFF-Statistical Assistants','OFF-Other Office And Administrative Support Workers','FFF-First-Line Supervisors Of Farming, Fishing, And Forestry Workers','FFF-Agricultural Inspectors','FFF-Graders And Sorters, Agricultural Products','FFF-Other Agricultural Workers','FFF-Fishing And Hunting Workers','FFF-Forest And Conservation Workers','FFF-Logging Workers','CON-First-Line Supervisors Of Construction Trades And Extraction Workers','CON-Boilermakers','CON-Carpenters','CON-Carpet, Floor, And Tile Installers And Finishers','CON-Cement Masons, Concrete Finishers, And Terrazzo Workers','CON-Construction Laborers','CON-Construction Equipment Operators','CON-Drywall Installers, Ceiling Tile Installers, And Tapers','CON-Electricians','CON-Glaziers','CON-Insulation Workers','CON-Painters And Paperhangers','CON-Pipelayers','CON-Plumbers, Pipefitters, And Steamfitters','CON-Plasterers And Stucco Masons','CON-Roofers','CON-Sheet Metal Workers','CON-Structural Iron And Steel Workers','CON-Solar Photovoltaic Installers','CON-Brickmasons, Blockmasons, Stonemasons, And Reinforcing Iron And Rebar Workers','CON-Helpers, Construction Trades','CON-Construction And Building Inspectors','CON-Elevator Installers And Repairers','CON-Fence Erectors','CON-Hazardous Materials Removal Workers','CON-Highway Maintenance Workers','CON-Rail-Track Laying And Maintenance Equipment Operators','CON-Other Construction And Related Workers','EXT-Derrick, Rotary Drill, And Service Unit Operators, And Roustabouts, Oil, Gas, And Mining','EXT_Surface Mining Machine Operators And Earth Drillers','EXT-Explosives Workers, Ordnance Handling Experts, And Blasters','EXT-Underground Mining Machine Operators','EXT-Other Extraction Workers','RPR-First-Line Supervisors Of Mechanics, Installers, And Repairers','RPR-Computer, Automated Teller, And Office Machine Repairers','RPR-Radio And Telecommunications Equipment Installers And Repairers','RPR-Avionics Technicians','RPR-Electric Motor, Power Tool, And Related Repairers','RPR-Other Electrical And Electronic Equipment Mechanics, Installers, and Repairers','RPR-Electronic Home Entertainment Equipment Installers And Repairers','RPR-Security And Fire Alarm Systems Installers','RPR-Aircraft Mechanics And Service Technicians','RPR-Automotive Body And Related Repairers','RPR-Automotive Glass Installers And Repairers','RPR-Automotive Service Technicians And Mechanics','RPR-Bus And Truck Mechanics And Diesel Engine Specialists','RPR-Heavy Vehicle And Mobile Equipment Service Technicians And Mechanics','RPR-Small Engine Mechanics','RPR-Miscellaneous Vehicle And Mobile Equipment Mechanics, Installers, And Repairers','RPR-Control And Valve Installers And Repairers','RPR-Heating, Air Conditioning, And Refrigeration Mechanics And Installers','RPR-Home Appliance Repairers','RPR-Industrial And Refractory Machinery Mechanics','RPR-Maintenance Workers, Machinery','RPR-Millwrights','RPR-Electrical Power-Line Installers And Repairers','RPR-Telecommunications Line Installers And Repairers','RPR-Precision Instrument And Equipment Repairers','RPR-Maintenance And Repair Workers, General','RPR-Coin, Vending, And Amusement Machine Servicers And Repairers','RPR-Locksmiths And Safe Repairers','RPR-Riggers','RPR-Helpers--Installation, Maintenance, And Repair Workers','RPR-Other Installation, Maintenance, And Repair Workers','PRD-First-Line Supervisors Of Production And Operating Workers','PRD-Electrical, Electronics, And Electromechanical Assemblers','PRD-Engine And Other Machine Assemblers','PRD-Structural Metal Fabricators And Fitters','PRD-Other Assemblers and Fabricators','PRD-Bakers','PRD-Butchers And Other Meat, Poultry, And Fish Processing Workers','PRD-Food And Tobacco Roasting, Baking, And Drying Machine Operators And Tenders','PRD-Food Batchmakers','PRD-Food Cooking Machine Operators And Tenders','PRD-Food Processing Workers, All Other','PRD-Computer Numerically Controlled Tool Operators And Programmers','PRD-Forming Machine Setters, Operators, And Tenders, Metal And Plastic','PRD-Cutting, Punching, And Press Machine Setters, Operators, And Tenders, Metal And Plastic','Grinding, Lapping, Polishing, And Buffing Machine Tool Setters, Operators, And Tenders, Metal and Plastic','Other Machine Tool Setters, Operators, And Tenders, Metal And Plastic','PRD-Machinists','PRD-Metal Furnace Operators, Tenders, Pourers, And Casters','PRD-Model Makers, Patternmakers, And Molding Machine Setters, Metal And Plastic','PRD-Tool And Die Makers','PRD-Welding, Soldering, And Brazing Workers','PRD-Other Metal Workers And Plastic Workers','PRD-Prepress Technicians And Workers','PRD-Printing Press Operators','PRD-Print Binding And Finishing Workers','PRD-Laundry And Dry-Cleaning Workers','PRD-Pressers, Textile, Garment, And Related Materials','PRD-Sewing Machine Operators','PRD-Shoe And Leather Workers','PRD-Tailors, Dressmakers, And Sewers','PRD-Textile Machine Setters, Operators, And Tenders','PRD-Upholsterers','PRD-Other Textile, Apparel, And Furnishings Workers','PRD-Cabinetmakers And Bench Carpenters','PRD-Furniture Finishers','PRD-Sawing Machine Setters, Operators, And Tenders, Wood','PRD-Woodworking Machine Setters, Operators, And Tenders, Except Sawing','PRD-Other Woodworkers','PRD-Power Plant Operators, Distributors, And Dispatchers','PRD-Stationary Engineers And Boiler Operators','PRD-Water And Wastewater Treatment Plant And System Operators','PRD-Miscellaneous Plant And System Operators','PRD-Chemical Processing Machine Setters, Operators, And Tenders','PRD-Crushing, Grinding, Polishing, Mixing, And Blending Workers','PRD-Cutting Workers','PRD-Extruding, Forming, Pressing, And Compacting Machine Setters, Operators, And Tenders','PRD-Furnace, Kiln, Oven, Drier, And Kettle Operators And Tenders','PRD-Inspectors, Testers, Sorters, Samplers, And Weighers','PRD-Jewelers And Precious Stone And Metal Workers','Dental And Ophthalmic Laboratory Technicians And Medical Appliance Technicians','PRD-Packaging And Filling Machine Operators And Tenders','PRD-Painting Workers','PRD-Photographic Process Workers And Processing Machine Operators','PRD-Adhesive Bonding Machine Operators And Tenders','PRD-Etchers And Engravers','PRD-Molders, Shapers, And Casters, Except Metal And Plastic','PRD-Paper Goods Machine Setters, Operators, And Tenders','PRD-Tire Builders','PRD-Helpers-Production Workers','PRD-Miscellaneous Production Workers, Including Equipment Operators and Tenders','TRN-Supervisors Of Transportation And Material Moving Workers','TRN-Aircraft Pilots And Flight Engineers','TRN-Air Traffic Controllers And Airfield Operations Specialists','TRN-Flight Attendants','TRN-Ambulance Drivers And Attendants, Except Emergency Medical Technicians','TRN-Bus Drivers, School','TRN-Bus Drivers, Transit And Intercity','TRN-Driver or Sales Workers And Truck Drivers','TRN-Shuttle Drivers and Chauffeurs','TRN-Taxi Drivers','TRN-Motor Vehicle Operators, All Other','TRN-Locomotive Engineers And Operators','TRN-Railroad Conductors And Yardmasters','TRN-Other Rail Transportation Workers','TRN-Sailors And Marine Oilers, And Ship Engineers','TRN-Ship And Boat Captains And Operators','TRN-Parking Lot Attendants','TRN-Transportation Service Attendants','TRN-Transportation Inspectors','TRN-Passenger Attendants','TRN-Other Transportation Workers','TRN-Crane And Tower Operators','TRN-Conveyor, Dredge, And Hoist And Winch Operators','TRN-Industrial Truck And Tractor Operators','TRN-Cleaners Of Vehicles And Equipment','TRN-Laborers And Freight, Stock, And Material Movers, Hand','TRN-Machine Feeders And Offbearers','TRN-Packers And Packagers, Hand','TRN-Stockers And Order Fillers','TRN-Pumping Station Operators','TRN-Refuse And Recyclable Material Collectors','TRN-Other Material Moving Workers','MIL-Military Officer Special And Tactical Operations Leaders','MIL-First-Line Enlisted Military Supervisors','MIL-Military Enlisted Tactical Operations And Air or Weapons Specialists And Crew Members','MIL-Military, Rank Not Specified','Unemployed And Last Worked 5 Years Ago Or Earlier Or Never Worked') AS "Standard Occupational Classification (SOC) codes for 2018 and later based on 2018 SOC codes",
CASE VPS
...
FROM read_csv('/Users/me/data/american_community_survey/2018/1-Year/csv_pus/psam_pusb.csv', 
              parallel=False,
              all_varchar=True,
              auto_detect=True)