-- SQL transformation for psam_p42 generated by generate_sql_with_enum_types_and_mapped_values.py
{{ config(materialized='external', location=var('output_path') + '/individual_people_pennsylvania_enum_types_mapped.parquet') }}
