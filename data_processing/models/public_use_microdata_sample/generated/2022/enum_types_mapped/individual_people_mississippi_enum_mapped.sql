-- SQL transformation for psam_p28 generated by generate_sql_with_enum_types_and_mapped_values.py
{{ config(materialized='external', location=var('output_path') + '/individual_people_mississippi_enum_types_mapped.parquet') }}
