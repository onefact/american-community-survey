-- SQL transformation for psam_pusa generated by generate_sql_with_enum_types_and_mapped_values.py
{{ config(materialized='external', location=var('output_path') + '/individual_people_united_states_first_tranche_enum_types_mapped.parquet') }}
