...
{{ config(materialized='external', location=var('output_path') + '/acs_pums_individual_people_puerto_rico_2022.parquet') }}
...
FROM read_csv('~/data/american_community_survey/2022/1-Year/csv_ppr/psam_p72.csv', 
              parallel=False,
              all_varchar=True,
              auto_detect=True)
