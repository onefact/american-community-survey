...
{{ config(materialized='external', location=var('output_path') + '/acs_pums_individual_people_alaska_2022.parquet') }}
...
FROM read_csv('~/data/american_community_survey/2022/1-Year/csv_pak/psam_p02.csv', 
              parallel=False,
              all_varchar=True,
              auto_detect=True)
