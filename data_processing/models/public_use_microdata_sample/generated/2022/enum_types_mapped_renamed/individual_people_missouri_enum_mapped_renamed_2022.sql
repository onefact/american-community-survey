...
{{ config(materialized='external', location=var('output_path') + '/acs_pums_individual_people_missouri_2022.parquet') }}
...
FROM read_csv('~/data/american_community_survey/2022/1-Year/csv_pmo/psam_p29.csv', 
              parallel=False,
              all_varchar=True,
              auto_detect=True)
