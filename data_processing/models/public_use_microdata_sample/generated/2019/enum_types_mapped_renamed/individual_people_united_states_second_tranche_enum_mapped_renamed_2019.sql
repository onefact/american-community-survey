...
{{ config(materialized='external', location=var('output_path') + '/acs_pums_individual_people_united_states_second_tranche_2019.parquet') }}
...
CASE CITWP
		...
		WHEN '2018' THEN '2018'
		WHEN '2019' THEN '2019'
	END::ENUM ('Not eligible - not naturalized','1944 or earlier - Bottom-coded','1945 - 1947','1948 - 1949','1950','1951','1952','1953','1954','1955','1956','1957','1958','1959','1960','1961','1962','1963','1964','1965','1966','1967','1968','1969','1970','1971','1972','1973','1974','1975','1976','1977','1978','1979','1980','1981','1982','1983','1984','1985','1986','1987','1988','1989','1990','1991','1992','1993','1994','1995','1996','1997','1998','1999','2000','2001','2002','2003','2004','2005','2006','2007','2008','2009','2010','2011','2012','2013','2014','2015','2016','2017','2018','2019') AS "Year of naturalization write-in",
CASE COW
...
CASE JWTRNS
		...
		WHEN '04' THEN 'Long-distance train or commuter train'
	...
	END::ENUM ('Not applicable - not a worker-not in the labor force, including persons under 16 years; unemployed; employed, with a job but not at work; Armed Forces, with a job but not at work','Car, truck, or van','Bus','Subway or elevated rail','Long-distance train or commuter train','Light rail, streetcar, or trolley','Ferryboat','Taxicab','Motorcycle','Bicycle','Walked','Worked from home','Other method') AS "Means of transportation to work",
...
CASE MARHYP
		...
		WHEN '1940' THEN '1940 or earlier - Bottom-coded'
		WHEN '1941' THEN '1941'
		WHEN '1942' THEN '1942'
		WHEN '1943' THEN '1943'
		WHEN '1944' THEN '1944'
		...
		WHEN '2018' THEN '2018'
		WHEN '2019' THEN '2019'
	END::ENUM ('Not applicable - age less than 15 years; never married','1940 or earlier - Bottom-coded','1941','1942','1943','1944','1945','1946','1947','1948','1949','1950','1951','1952','1953','1954','1955','1956','1957','1958','1959','1960','1961','1962','1963','1964','1965','1966','1967','1968','1969','1970','1971','1972','1973','1974','1975','1976','1977','1978','1979','1980','1981','1982','1983','1984','1985','1986','1987','1988','1989','1990','1991','1992','1993','1994','1995','1996','1997','1998','1999','2000','2001','2002','2003','2004','2005','2006','2007','2008','2009','2010','2011','2012','2013','2014','2015','2016','2017','2018','2019') AS "Year last married",
CASE MIG
...
CASE YOEP
		...
		WHEN '2018' THEN '2018'
		WHEN '2019' THEN '2019'
	END::ENUM ('Not eligible - Born in the US','1929 or earlier - Bottom-coded','1930 - 1934','1935 - 1938','1939 - 1940','1941 - 1942','1943 - 1944','1945','1946','1947','1948','1949','1950','1951','1952','1953','1954','1955','1956','1957','1958','1959','1960','1961','1962','1963','1964','1965','1966','1967','1968','1969','1970','1971','1972','1973','1974','1975','1976','1977','1978','1979','1980','1981','1982','1983','1984','1985','1986','1987','1988','1989','1990','1991','1992','1993','1994','1995','1996','1997','1998','1999','2000','2001','2002','2003','2004','2005','2006','2007','2008','2009','2010','2011','2012','2013','2014','2015','2016','2017','2018','2019') AS "Year of entry",
CASE ANC
		WHEN '1' THEN 'Single'
...
CASE INDP
		...
		WHEN '2190' THEN 'MFG-Pharmaceuticals And Medicine'
...
CASE NAICSP
		...
		WHEN '3254' THEN 'MFG-Pharmaceuticals And Medicine'
...
CASE OCCP
		...
		WHEN '2636' THEN 'ENT-Merchandise Displayer And Windows Trimmers'
...
CASE SOCP
		...
		WHEN '271026' THEN 'ENT-Merchandise Displayer And Windows Trimmers'
...
FROM read_csv('/Users/me/data/american_community_survey/2019/1-Year/csv_pus/psam_pusb.csv', 
              parallel=False,
              all_varchar=True,
              auto_detect=True)