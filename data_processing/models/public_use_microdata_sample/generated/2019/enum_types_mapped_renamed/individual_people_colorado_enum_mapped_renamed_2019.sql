...
{{ config(materialized='external', location=var('output_path') + '/acs_pums_individual_people_colorado_2019.parquet') }}
...
FROM read_csv('/Users/me/data/american_community_survey/2019/1-Year/csv_pco/psam_p08.csv', 
              parallel=False,
              all_varchar=True,
              auto_detect=True)